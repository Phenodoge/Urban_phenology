...
data_treat <- read_excel("D:/0 Work/Work/3 BNU/Lab/2 Manuscripts/3 Manuscript/20240730 NC/4 Major revision/2 MS/20241127 MS_Submit/data/Manipulative experiment.xlsx", sheet = "Sheet1")
...
data_treat <- read_excel("D:/0 Work/Work/3 BNU/Lab/2 Manuscripts/3 Manuscript/20240730 NC/4 Major revision/2 MS/20241127 MS_Submit/data/Manipulative experiment.xlsx", sheet = "Sheet2")
...
### 3.1 chilling  #############
rm(list=ls())
tgc <- read_excel("D:/0 Work/Work/3 BNU/Lab/2 Manuscripts/3 Manuscript/20240730 NC/4 Major revision/2 MS/20241127 MS_Submit/data/Manipulative experiment.xlsx", sheet = "Sheet3")
...
### 3.2 photoperiod  #############
rm(list=ls())
tgc <- read_excel("D:/0 Work/Work/3 BNU/Lab/2 Manuscripts/3 Manuscript/20240730 NC/4 Major revision/2 MS/20241127 MS_Submit/data/Manipulative experiment.xlsx", sheet = "Sheet4")
